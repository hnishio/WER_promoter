...
RNA <- read.csv("RNA_monthmean_ampRNAover3_edgeR_cosinor_210309.csv")
K4 <- read.csv("K4K27_monthmean_ampK4over1_edgeR_cosinor_210309.csv")
K4up1000 <- read.csv("K4K27_TSSup1000_monthmean_ampK4over1_edgeR_cosinor.csv")
K27up1000 <- read.csv("K4K27_TSSup1000_monthmean_ampK27over1_edgeR_cosinor.csv")
K27under2 <- read.csv("K4K27_data_stat_maxK27under2.csv")
nrow(RNA)
nrow(K4)
nrow(K4up1000)
nrow(K27up1000)
nrow(K27under2)
names(K4up1000) <- gsub("K4", "K4up1000", names(K4up1000))
names(K4up1000) <- gsub("K27", "K27up1000", names(K4up1000))
names(K27up1000) <- gsub("K4", "K4up1000", names(K27up1000))
names(K27up1000) <- gsub("K27", "K27up1000", names(K27up1000))


# RNA vs. K27_up1000
RNA_K27up1000 <- merge(RNA, K27up1000, by=c("Ahal_ID"),all=F,sort=F)
RNA_K27up1000_2 <- RNA_K27up1000[,c(1,16:21,2:13,22:45,14,15,46:49)]

Cor_RNA_K27up1000 <- rep(NA, length=nrow(RNA_K27up1000_2))
for(i in 1:nrow(RNA_K27up1000_2)){
  Cor_RNA_K27up1000[i] <- round(cor(as.numeric(RNA_K27up1000_2[i,8:19]), 
                                    as.numeric(RNA_K27up1000_2[i,32:43]), 
                                    method="spearman"), 
                                digits=2)
}

RNA_K27up1000_3 <- cbind(RNA_K27up1000_2, Cor_RNA_K27up1000)
RNA_K27up1000_4 <- RNA_K27up1000_3[order(RNA_K27up1000_3$Cor_RNA_K27up1000),]
RNA_K27up1000_5 <- merge(RNA_K27up1000_4, K27under2, by=names(RNA_K27up1000_4)[1:7], all=F, sort=F)
RNA_K27up1000_6 <- RNA_K27up1000_5[,1:ncol(RNA_K27up1000_4)]
nrow(RNA_K27up1000_6)
write.csv(RNA_K27up1000_6, file="RNA_K27TSSup1000_monthmean_cor_210309.csv", quote=F, row.names=F)


# K4 vs. K27_up1000
K4_K27up1000 <- merge(K4, K27up1000, by=names(K4)[1:7], all=F, sort=F)
K4_K27up1000_2 <- K4_K27up1000[,c(1:31,36:59,32:35,60:63)]

Cor_K4_K27up1000 <- rep(NA, length=nrow(K4_K27up1000_2))
for(i in 1:nrow(K4_K27up1000_2)){
  Cor_K4_K27up1000[i] <- round(cor(as.numeric(K4_K27up1000_2[i,8:19]), 
                                    as.numeric(K4_K27up1000_2[i,44:55]), 
                                    method="spearman"), 
                                digits=2)
}

K4_K27up1000_3 <- cbind(K4_K27up1000_2, Cor_K4_K27up1000)
K4_K27up1000_4 <- K4_K27up1000_3[order(K4_K27up1000_3$Cor_K4_K27up1000),]
K4_K27up1000_5 <- merge(K4_K27up1000_4, K27under2, by=names(K4_K27up1000_4)[1:7], all=F, sort=F)
K4_K27up1000_6 <- K4_K27up1000_5[,1:ncol(K4_K27up1000_4)]
nrow(K4_K27up1000_6)
write.csv(K4_K27up1000_6, file="K4_K27TSSup1000_monthmean_cor_210309.csv", quote=F, row.names=F)


# RNA, K4 vs. K27_up1000
RNA_K4_K27up1000 <- merge(RNA_K27up1000_6[,c(1:19,44,45,50)], K4_K27up1000_6, by=names(RNA_K27up1000_4)[1:7], all=F, sort=F)
RNA_K4_K27up1000_2 <- RNA_K4_K27up1000[,c(1:19,23:70,20,21,71:78,22,79)]
nrow(RNA_K4_K27up1000_2)
write.csv(RNA_K4_K27up1000_2, file="RNA_K4_K27TSSup1000_monthmean_cor_210309.csv", quote=F, row.names=F)
...
RNA <- read.csv("RNA_monthmean_ampRNAover3_edgeR_cosinor_210309.csv")
K4 <- read.csv("K4K27_monthmean_ampK4over1_edgeR_cosinor_210309.csv")
K4up2000 <- read.csv("K4K27_TSSup2000_monthmean_ampK4over1_edgeR_cosinor.csv")
K27up2000 <- read.csv("K4K27_TSSup2000_monthmean_ampK27over1_edgeR_cosinor.csv")
K27under2 <- read.csv("K4K27_data_stat_maxK27under2.csv")
nrow(RNA)
nrow(K4)
nrow(K4up2000)
nrow(K27up2000)
nrow(K27under2)
names(K4up2000) <- gsub("K4", "K4up2000", names(K4up2000))
names(K4up2000) <- gsub("K27", "K27up2000", names(K4up2000))
names(K27up2000) <- gsub("K4", "K4up2000", names(K27up2000))
names(K27up2000) <- gsub("K27", "K27up2000", names(K27up2000))


# RNA vs. K27_up2000
RNA_K27up2000 <- merge(RNA, K27up2000, by=c("Ahal_ID"),all=F,sort=F)
RNA_K27up2000_2 <- RNA_K27up2000[,c(1,16:21,2:13,22:45,14,15,46:49)]

Cor_RNA_K27up2000 <- rep(NA, length=nrow(RNA_K27up2000_2))
for(i in 1:nrow(RNA_K27up2000_2)){
  Cor_RNA_K27up2000[i] <- round(cor(as.numeric(RNA_K27up2000_2[i,8:19]), 
                                    as.numeric(RNA_K27up2000_2[i,32:43]), 
                                    method="spearman"), 
                                digits=2)
}

RNA_K27up2000_3 <- cbind(RNA_K27up2000_2, Cor_RNA_K27up2000)
RNA_K27up2000_4 <- RNA_K27up2000_3[order(RNA_K27up2000_3$Cor_RNA_K27up2000),]
RNA_K27up2000_5 <- merge(RNA_K27up2000_4, K27under2, by=names(RNA_K27up2000_4)[1:7], all=F, sort=F)
RNA_K27up2000_6 <- RNA_K27up2000_5[,1:ncol(RNA_K27up2000_4)]
nrow(RNA_K27up2000_6)
write.csv(RNA_K27up2000_6, file="RNA_K27TSSup2000_monthmean_cor_210309.csv", quote=F, row.names=F)


# K4 vs. K27_up2000
K4_K27up2000 <- merge(K4, K27up2000, by=names(K4)[1:7], all=F, sort=F)
K4_K27up2000_2 <- K4_K27up2000[,c(1:31,36:59,32:35,60:63)]

Cor_K4_K27up2000 <- rep(NA, length=nrow(K4_K27up2000_2))
for(i in 1:nrow(K4_K27up2000_2)){
  Cor_K4_K27up2000[i] <- round(cor(as.numeric(K4_K27up2000_2[i,8:19]), 
                                   as.numeric(K4_K27up2000_2[i,44:55]), 
                                   method="spearman"), 
                               digits=2)
}

K4_K27up2000_3 <- cbind(K4_K27up2000_2, Cor_K4_K27up2000)
K4_K27up2000_4 <- K4_K27up2000_3[order(K4_K27up2000_3$Cor_K4_K27up2000),]
K4_K27up2000_5 <- merge(K4_K27up2000_4, K27under2, by=names(K4_K27up2000_4)[1:7], all=F, sort=F)
K4_K27up2000_6 <- K4_K27up2000_5[,1:ncol(K4_K27up2000_4)]
nrow(K4_K27up2000_6)
write.csv(K4_K27up2000_6, file="K4_K27TSSup2000_monthmean_cor_210309.csv", quote=F, row.names=F)


# RNA, K4 vs. K27_up2000
RNA_K4_K27up2000 <- merge(RNA_K27up2000_6[,c(1:19,44,45,50)], K4_K27up2000_6, by=names(RNA_K27up2000_4)[1:7], all=F, sort=F)
RNA_K4_K27up2000_2 <- RNA_K4_K27up2000[,c(1:19,23:70,20,21,71:78,22,79)]
nrow(RNA_K4_K27up2000_2)
write.csv(RNA_K4_K27up2000_2, file="RNA_K4_K27TSSup2000_monthmean_cor_210309.csv", quote=F, row.names=F)
...
RNA <- read.csv("RNA_monthmean_ampRNAover3_edgeR_cosinor_210309.csv")
K4 <- read.csv("K4K27_monthmean_ampK4over1_edgeR_cosinor_210309.csv")
K4up3000 <- read.csv("K4K27_TSSup3000_monthmean_ampK4over1_edgeR_cosinor.csv")
K27up3000 <- read.csv("K4K27_TSSup3000_monthmean_ampK27over1_edgeR_cosinor.csv")
K27under2 <- read.csv("K4K27_data_stat_maxK27under2.csv")
nrow(RNA)
nrow(K4)
nrow(K4up3000)
nrow(K27up3000)
nrow(K27under2)
names(K4up3000) <- gsub("K4", "K4up3000", names(K4up3000))
names(K4up3000) <- gsub("K27", "K27up3000", names(K4up3000))
names(K27up3000) <- gsub("K4", "K4up3000", names(K27up3000))
names(K27up3000) <- gsub("K27", "K27up3000", names(K27up3000))


# RNA vs. K27_up3000
RNA_K27up3000 <- merge(RNA, K27up3000, by=c("Ahal_ID"),all=F,sort=F)
RNA_K27up3000_2 <- RNA_K27up3000[,c(1,16:21,2:13,22:45,14,15,46:49)]

Cor_RNA_K27up3000 <- rep(NA, length=nrow(RNA_K27up3000_2))
for(i in 1:nrow(RNA_K27up3000_2)){
  Cor_RNA_K27up3000[i] <- round(cor(as.numeric(RNA_K27up3000_2[i,8:19]), 
                                    as.numeric(RNA_K27up3000_2[i,32:43]), 
                                    method="spearman"), 
                                digits=2)
}

RNA_K27up3000_3 <- cbind(RNA_K27up3000_2, Cor_RNA_K27up3000)
RNA_K27up3000_4 <- RNA_K27up3000_3[order(RNA_K27up3000_3$Cor_RNA_K27up3000),]
RNA_K27up3000_5 <- merge(RNA_K27up3000_4, K27under2, by=names(RNA_K27up3000_4)[1:7], all=F, sort=F)
RNA_K27up3000_6 <- RNA_K27up3000_5[,1:ncol(RNA_K27up3000_4)]
nrow(RNA_K27up3000_6)
write.csv(RNA_K27up3000_6, file="RNA_K27TSSup3000_monthmean_cor_210309.csv", quote=F, row.names=F)


# K4 vs. K27_up3000
K4_K27up3000 <- merge(K4, K27up3000, by=names(K4)[1:7], all=F, sort=F)
K4_K27up3000_2 <- K4_K27up3000[,c(1:31,36:59,32:35,60:63)]

Cor_K4_K27up3000 <- rep(NA, length=nrow(K4_K27up3000_2))
for(i in 1:nrow(K4_K27up3000_2)){
  Cor_K4_K27up3000[i] <- round(cor(as.numeric(K4_K27up3000_2[i,8:19]), 
                                   as.numeric(K4_K27up3000_2[i,44:55]), 
                                   method="spearman"), 
                               digits=2)
}

K4_K27up3000_3 <- cbind(K4_K27up3000_2, Cor_K4_K27up3000)
K4_K27up3000_4 <- K4_K27up3000_3[order(K4_K27up3000_3$Cor_K4_K27up3000),]
K4_K27up3000_5 <- merge(K4_K27up3000_4, K27under2, by=names(K4_K27up3000_4)[1:7], all=F, sort=F)
K4_K27up3000_6 <- K4_K27up3000_5[,1:ncol(K4_K27up3000_4)]
nrow(K4_K27up3000_6)
write.csv(K4_K27up3000_6, file="K4_K27TSSup3000_monthmean_cor_210309.csv", quote=F, row.names=F)


# RNA, K4 vs. K27_up3000
RNA_K4_K27up3000 <- merge(RNA_K27up3000_6[,c(1:19,44,45,50)], K4_K27up3000_6, by=names(RNA_K27up3000_4)[1:7], all=F, sort=F)
RNA_K4_K27up3000_2 <- RNA_K4_K27up3000[,c(1:19,23:70,20,21,71:78,22,79)]
nrow(RNA_K4_K27up3000_2)
write.csv(RNA_K4_K27up3000_2, file="RNA_K4_K27TSSup3000_monthmean_cor_210309.csv", quote=F, row.names=F)
...
RNA <- read.csv("RNA_monthmean_ampRNAover3_edgeR_cosinor_210309.csv")
K4 <- read.csv("K4K27_monthmean_ampK4over1_edgeR_cosinor_210309.csv")
K4up6000 <- read.csv("K4K27_TSSup6000_monthmean_ampK4over1_edgeR_cosinor.csv")
K27up6000 <- read.csv("K4K27_TSSup6000_monthmean_ampK27over1_edgeR_cosinor.csv")
K27under2 <- read.csv("K4K27_data_stat_maxK27under2.csv")
nrow(RNA)
nrow(K4)
nrow(K4up6000)
nrow(K27up6000)
nrow(K27under2)
names(K4up6000) <- gsub("K4", "K4up6000", names(K4up6000))
names(K4up6000) <- gsub("K27", "K27up6000", names(K4up6000))
names(K27up6000) <- gsub("K4", "K4up6000", names(K27up6000))
names(K27up6000) <- gsub("K27", "K27up6000", names(K27up6000))


# RNA vs. K27_up6000
RNA_K27up6000 <- merge(RNA, K27up6000, by=c("Ahal_ID"),all=F,sort=F)
RNA_K27up6000_2 <- RNA_K27up6000[,c(1,16:21,2:13,22:45,14,15,46:49)]

Cor_RNA_K27up6000 <- rep(NA, length=nrow(RNA_K27up6000_2))
for(i in 1:nrow(RNA_K27up6000_2)){
  Cor_RNA_K27up6000[i] <- round(cor(as.numeric(RNA_K27up6000_2[i,8:19]), 
                                    as.numeric(RNA_K27up6000_2[i,32:43]), 
                                    method="spearman"), 
                                digits=2)
}

RNA_K27up6000_3 <- cbind(RNA_K27up6000_2, Cor_RNA_K27up6000)
RNA_K27up6000_4 <- RNA_K27up6000_3[order(RNA_K27up6000_3$Cor_RNA_K27up6000),]
RNA_K27up6000_5 <- merge(RNA_K27up6000_4, K27under2, by=names(RNA_K27up6000_4)[1:7], all=F, sort=F)
RNA_K27up6000_6 <- RNA_K27up6000_5[,1:ncol(RNA_K27up6000_4)]
nrow(RNA_K27up6000_6)
write.csv(RNA_K27up6000_6, file="RNA_K27TSSup6000_monthmean_cor_210309.csv", quote=F, row.names=F)


# K4 vs. K27_up6000
K4_K27up6000 <- merge(K4, K27up6000, by=names(K4)[1:7], all=F, sort=F)
K4_K27up6000_2 <- K4_K27up6000[,c(1:31,36:59,32:35,60:63)]

Cor_K4_K27up6000 <- rep(NA, length=nrow(K4_K27up6000_2))
for(i in 1:nrow(K4_K27up6000_2)){
  Cor_K4_K27up6000[i] <- round(cor(as.numeric(K4_K27up6000_2[i,8:19]), 
                                   as.numeric(K4_K27up6000_2[i,44:55]), 
                                   method="spearman"), 
                               digits=2)
}

K4_K27up6000_3 <- cbind(K4_K27up6000_2, Cor_K4_K27up6000)
K4_K27up6000_4 <- K4_K27up6000_3[order(K4_K27up6000_3$Cor_K4_K27up6000),]
K4_K27up6000_5 <- merge(K4_K27up6000_4, K27under2, by=names(K4_K27up6000_4)[1:7], all=F, sort=F)
K4_K27up6000_6 <- K4_K27up6000_5[,1:ncol(K4_K27up6000_4)]
nrow(K4_K27up6000_6)
write.csv(K4_K27up6000_6, file="K4_K27TSSup6000_monthmean_cor_210309.csv", quote=F, row.names=F)


# RNA, K4 vs. K27_up6000
RNA_K4_K27up6000 <- merge(RNA_K27up6000_6[,c(1:19,44,45,50)], K4_K27up6000_6, by=names(RNA_K27up6000_4)[1:7], all=F, sort=F)
RNA_K4_K27up6000_2 <- RNA_K4_K27up6000[,c(1:19,23:70,20,21,71:78,22,79)]
nrow(RNA_K4_K27up6000_2)
write.csv(RNA_K4_K27up6000_2, file="RNA_K4_K27TSSup6000_monthmean_cor_210309.csv", quote=F, row.names=F)



### Integration of TSSup1000-6000
RNA_K4_K27up1000 <- read.csv("RNA_K4_K27TSSup1000_monthmean_cor_210309.csv")
RNA_K4_K27up2000 <- read.csv("RNA_K4_K27TSSup2000_monthmean_cor_210309.csv")
RNA_K4_K27up3000 <- read.csv("RNA_K4_K27TSSup3000_monthmean_cor_210309.csv")
RNA_K4_K27up6000 <- read.csv("RNA_K4_K27TSSup6000_monthmean_cor_210309.csv")

RNA_K4_K27up1000_2000 <- merge(RNA_K4_K27up1000, RNA_K4_K27up2000, by=names(RNA_K4_K27up1000)[c(1:43,68:73)], all=F, sort=F)
nrow(RNA_K4_K27up1000_2000)
RNA_K4_K27up1000_2000_3000 <- merge(RNA_K4_K27up1000_2000, RNA_K4_K27up3000, by=names(RNA_K4_K27up1000_2000)[1:49], all=F, sort=F)
nrow(RNA_K4_K27up1000_2000_3000)
RNA_K4_K27up1000_2000_3000_6000 <- merge(RNA_K4_K27up1000_2000_3000, RNA_K4_K27up6000, by=names(RNA_K4_K27up1000_2000_3000)[1:49], all=F, sort=F)
nrow(RNA_K4_K27up1000_2000_3000_6000)
RNA_K4_K27up1000_2000_3000_6000_2 <- RNA_K4_K27up1000_2000_3000_6000[,c(1:43,50:73,80:103,110:133,140:163,
                                                                        44:49,74:77,104:107,134:137,164:167,78,79,108,109,138,139,168,169)]
write.csv(RNA_K4_K27up1000_2000_3000_6000_2, file="RNA_K4_K27TSSup1000-6000_monthmean_cor_210309.csv", quote=F, row.names=F)


# Correlation test
p.values1 <- numeric(); p.values2 <- numeric()
for(i in 1:nrow(RNA_K4_K27up1000)){
  p.value1 <- cor.test(as.numeric(RNA_K4_K27up1000[i,8:19]), as.numeric(RNA_K4_K27up1000[i,56:67]), 
                       method="spearman")$p.value
  p.value2 <- cor.test(as.numeric(RNA_K4_K27up1000[i,20:31]), as.numeric(RNA_K4_K27up1000[i,56:67]), 
                       method="spearman")$p.value
  p.values1 <- c(p.values1, p.value1); p.values2 <- c(p.values2, p.value2)
}
(data.frame(RNA_K27up1000_cor=p.values1, K4_K27up1000_cor=p.values2))


p.values1 <- numeric(); p.values2 <- numeric()
for(i in 1:nrow(RNA_K4_K27up2000)){
  p.value1 <- cor.test(as.numeric(RNA_K4_K27up2000[i,8:19]), as.numeric(RNA_K4_K27up2000[i,56:67]), 
                       method="spearman")$p.value
  p.value2 <- cor.test(as.numeric(RNA_K4_K27up2000[i,20:31]), as.numeric(RNA_K4_K27up2000[i,56:67]), 
                       method="spearman")$p.value
  p.values1 <- c(p.values1, p.value1); p.values2 <- c(p.values2, p.value2)
}
(data.frame(RNA_K27up2000_cor=p.values1, K4_K27up2000_cor=p.values2))
...
##### Spearman's rank correlation between seasonal changes of K27 and K4 #####
RNA <- read.csv("RNA_monthmean_ampRNAover3_edgeR_cosinor_210309.csv")
K4 <- read.csv("K4K27_monthmean_ampK4over2_edgeR_cosinor_210309.csv")
K4up1000 <- read.csv("K4K27_TSSup1000_monthmean_ampK4over2_edgeR_cosinor.csv")
K27up1000 <- read.csv("K4K27_TSSup1000_monthmean_ampK27over2_edgeR_cosinor.csv")
K27under2 <- read.csv("K4K27_data_stat_maxK27under2.csv")
nrow(RNA)
nrow(K4)
nrow(K4up1000)
...
K4_K27up1000_6 <- K4_K27up1000_5[,1:ncol(K4_K27up1000_4)]
nrow(K4_K27up1000_6)
write.csv(K4_K27up1000_6, file="K4over2_K27TSSup1000_monthmean_cor_210309.csv", quote=F, row.names=F)
...
# Venn diagram
dir.create("../figs/RNA_K4_K27up_venn")

RNA <- read.csv("RNA_monthmean_ampRNAover3_edgeR_cosinor_210309.csv")
K4 <- read.csv("K4K27_monthmean_ampK4over1_edgeR_cosinor_210309.csv")
K27up1000 <- read.csv("K4K27_TSSup1000_monthmean_ampK27over1_edgeR_cosinor.csv")
RNA_K4 <- merge(RNA, K4, by="Ahal_ID", all=F, sort=F)
RNA_K27up1000 <- read.csv("RNA_K27TSSup1000_monthmean_cor_210309.csv")
K4_K27up1000 <- read.csv("K4_K27TSSup1000_monthmean_cor_210309.csv")
RNA_K4_K27up1000 <- read.csv("RNA_K4_K27TSSup1000_monthmean_cor_210309.csv")

pdf("../figs/RNA_K4_K27up_venn/venn_RNA_K4_K27up1000.pdf",height=2.5,width=2.5)
draw.triple.venn(
  area1=nrow(RNA), area2=nrow(K4), area3=nrow(K27up1000),
  n12=nrow(RNA_K4), n23=nrow(RNA_K27up1000), n13=nrow(K4_K27up1000),
  n123=nrow(RNA_K4_K27up1000),
  cex=1, category=c("RNA","H3K4me3","H3K27me3\n(1,000bp upstream from TSS)"), cat.cex=c(1,1,1), 
...
K27up2000 <- read.csv("K4K27_TSSup2000_monthmean_ampK27over1_edgeR_cosinor.csv")
RNA_K4 <- merge(RNA, K4, by="Ahal_ID", all=F, sort=F)
RNA_K27up2000 <- read.csv("RNA_K27TSSup2000_monthmean_cor_210309.csv")
K4_K27up2000 <- read.csv("K4_K27TSSup2000_monthmean_cor_210309.csv")
RNA_K4_K27up2000 <- read.csv("RNA_K4_K27TSSup2000_monthmean_cor_210309.csv")

pdf("../figs/RNA_K4_K27up_venn/venn_RNA_K4_K27up2000.pdf",height=2.5,width=2.5)
draw.triple.venn(
  area1=nrow(RNA), area2=nrow(K4), area3=nrow(K27up2000),
  n12=nrow(RNA_K4), n23=nrow(RNA_K27up2000), n13=nrow(K4_K27up2000),
  n123=nrow(RNA_K4_K27up2000),
  cex=1, category=c("RNA","H3K4me3","H3K27me3\n(2,000bp upstream from TSS)"), cat.cex=c(1,1,1), 
  fontfamily="sans", col=rep("transparent",3),
  fill=c(rgb(0.5,0,0),rgb(1,0,0),"orange"), alpha=rep(0.5,3),
  cat.pos=c(330,30,180), cat.dist=rep(0.05,3), cat.fontfamily="sans",
  cat.col=c(rgb(0.5,0,0),rgb(1,0,0),"orange"), margin=0.1
...
K27up3000 <- read.csv("K4K27_TSSup3000_monthmean_ampK27over1_edgeR_cosinor.csv")
RNA_K4 <- merge(RNA, K4, by="Ahal_ID", all=F, sort=F)
RNA_K27up3000 <- read.csv("RNA_K27TSSup3000_monthmean_cor_210309.csv")
K4_K27up3000 <- read.csv("K4_K27TSSup3000_monthmean_cor_210309.csv")
RNA_K4_K27up3000 <- read.csv("RNA_K4_K27TSSup3000_monthmean_cor_210309.csv")

pdf("../figs/RNA_K4_K27up_venn/venn_RNA_K4_K27up3000.pdf",height=2.5,width=2.5)
draw.triple.venn(
  area1=nrow(RNA), area2=nrow(K4), area3=nrow(K27up3000),
  n12=nrow(RNA_K4), n23=nrow(RNA_K27up3000), n13=nrow(K4_K27up3000),
  n123=nrow(RNA_K4_K27up3000),
  cex=1, category=c("RNA","H3K4me3","H3K27me3\n(3,000bp upstream from TSS)"), cat.cex=c(1,1,1), 
  fontfamily="sans", col=rep("transparent",3),
  fill=c(rgb(0.5,0,0),rgb(1,0,0),"orange"), alpha=rep(0.5,3),
  cat.pos=c(330,30,180), cat.dist=rep(0.05,3), cat.fontfamily="sans",
  cat.col=c(rgb(0.5,0,0),rgb(1,0,0),"orange"), margin=0.1
...
K27up6000 <- read.csv("K4K27_TSSup6000_monthmean_ampK27over1_edgeR_cosinor.csv")
RNA_K4 <- merge(RNA, K4, by="Ahal_ID", all=F, sort=F)
RNA_K27up6000 <- read.csv("RNA_K27TSSup6000_monthmean_cor_210309.csv")
K4_K27up6000 <- read.csv("K4_K27TSSup6000_monthmean_cor_210309.csv")
RNA_K4_K27up6000 <- read.csv("RNA_K4_K27TSSup6000_monthmean_cor_210309.csv")

pdf("../figs/RNA_K4_K27up_venn/venn_RNA_K4_K27up6000.pdf",height=2.5,width=2.5)
draw.triple.venn(
  area1=nrow(RNA), area2=nrow(K4), area3=nrow(K27up6000),
  n12=nrow(RNA_K4), n23=nrow(RNA_K27up6000), n13=nrow(K4_K27up6000),
  n123=nrow(RNA_K4_K27up6000),
  cex=1, category=c("RNA","H3K4me3","H3K27me3\n(6,000bp upstream from TSS)"), cat.cex=c(1,1,1), 
  fontfamily="sans", col=rep("transparent",3),
  fill=c(rgb(0.5,0,0),rgb(1,0,0),"orange"), alpha=rep(0.5,3),
  cat.pos=c(330,30,180), cat.dist=rep(0.05,3), cat.fontfamily="sans",
  cat.col=c(rgb(0.5,0,0),rgb(1,0,0),"orange"), margin=0.1
...
g1 <- ggplot(RNA_K27up1000, aes(x=Cor_RNA_K27up1000)) + 
  geom_histogram(color="gray50",binwidth=0.1, position = "identity", alpha = 0.5) +
  ...
  labs(title="", 
       x="Correlation between seasonal changes of\nmRNA and H3K27me3\n(1,000 bp upstream from TSS)", 
       y="No. of genes")

g2 <- ggplot(K4_K27up1000, aes(x=Cor_K4_K27up1000)) + 
  geom_histogram(color="gray50",binwidth=0.1, position = "identity", alpha = 0.5) +
  geom_vline(xintercept=0, linetype="dashed") +
  coord_cartesian(xlim=c(-1,1)) +
  theme_bw() +
...
g3 <- ggplot(RNA_K27up2000, aes(x=Cor_RNA_K27up2000)) + 
  geom_histogram(color="gray50",binwidth=0.1, position = "identity", alpha = 0.5) +
  geom_vline(xintercept=0, linetype="dashed") +
  coord_cartesian(xlim=c(-1,1)) +
  theme_bw() +
  theme(axis.title=element_text(size=7), 
        axis.text=element_text(size=7)) + 
  labs(title="", 
       x="Correlation between seasonal changes of\nmRNA and H3K27me3\n(2,000 bp upstream from TSS)", 
       y="No. of genes")

g4 <- ggplot(K4_K27up2000, aes(x=Cor_K4_K27up2000)) + 
  geom_histogram(color="gray50",binwidth=0.1, position = "identity", alpha = 0.5) +
  geom_vline(xintercept=0, linetype="dashed") +
  coord_cartesian(xlim=c(-1,1)) +
  theme_bw() +
...
g5 <- ggplot(RNA_K27up3000, aes(x=Cor_RNA_K27up3000)) + 
  geom_histogram(color="gray50",binwidth=0.1, position = "identity", alpha = 0.5) +
  geom_vline(xintercept=0, linetype="dashed") +
  coord_cartesian(xlim=c(-1,1)) +
  theme_bw() +
  theme(axis.title=element_text(size=7), 
        axis.text=element_text(size=7)) + 
  labs(title="", 
       x="Correlation between seasonal changes of\nmRNA and H3K27me3\n(3,000 bp upstream from TSS)", 
       y="No. of genes")

g6 <- ggplot(K4_K27up3000, aes(x=Cor_K4_K27up3000)) + 
  geom_histogram(color="gray50",binwidth=0.1, position = "identity", alpha = 0.5) +
  geom_vline(xintercept=0, linetype="dashed") +
  coord_cartesian(xlim=c(-1,1)) +
  theme_bw() +
...
g7 <- ggplot(RNA_K27up6000, aes(x=Cor_RNA_K27up6000)) + 
  geom_histogram(color="gray50",binwidth=0.1, position = "identity", alpha = 0.5) +
  geom_vline(xintercept=0, linetype="dashed") +
  coord_cartesian(xlim=c(-1,1)) +
  theme_bw() +
  theme(axis.title=element_text(size=7), 
        axis.text=element_text(size=7)) + 
  labs(title="", 
       x="Correlation between seasonal changes of\nmRNA and H3K27me3\n(6,000 bp upstream from TSS)", 
       y="No. of genes")

g8 <- ggplot(K4_K27up6000, aes(x=Cor_K4_K27up6000)) + 
  geom_histogram(color="gray50",binwidth=0.1, position = "identity", alpha = 0.5) +
  geom_vline(xintercept=0, linetype="dashed") +
  coord_cartesian(xlim=c(-1,1)) +
  theme_bw() +
...
# Adjustment of the plot width 
glists <- list(g1,g2,g3,g4,g5,g6,g7,g8)
glists_Grob <- lapply(glists, ggplotGrob)
gwidth <- do.call(unit.pmax, lapply(glists_Grob, "[[", "widths"))
glists_Grob_gwidth <- lapply(glists_Grob, "[[<-", "widths", value = gwidth)
gall <- gridExtra::grid.arrange(grobs=glists_Grob_gwidth, nrow=4)

ggsave("../figs/histogram/hist_RNA_K4_K27TSSup1000-6000_monthmean_cor_210309.pdf", 
       gall, height = 7.2, width = 4.4)
...
### Scatter plot of ADH1

dir.create("../figs/scatter")

RNA_K4_K27up1000_6000 <- read.csv("RNA_K4_K27TSSup1000-6000_monthmean_cor_210309.csv")
...
df <- data.frame(
  RNA=normalize(as.numeric(RNA_K4_K27up1000_6000[2,8:19])),
  K4=normalize(as.numeric(RNA_K4_K27up1000_6000[2,20:31])),
  K27up1000=normalize(as.numeric(RNA_K4_K27up1000_6000[2,56:67])),
  K27up2000=normalize(as.numeric(RNA_K4_K27up1000_6000[2,80:91])),
  K27up3000=normalize(as.numeric(RNA_K4_K27up1000_6000[2,104:115])),
  K27up6000=normalize(as.numeric(RNA_K4_K27up1000_6000[2,128:139]))
)

cor <- as.numeric(RNA_K4_K27up1000_6000[2,162:169])
mylabs <- c(parse(text=sprintf('rho=="%.2f"', cor[1])), 
            parse(text=sprintf('rho=="%.2f"', cor[2])),
            parse(text=sprintf('rho=="%.2f"', cor[3])),
            parse(text=sprintf('rho=="%.2f"', cor[4])),
            parse(text=sprintf('rho=="%.2f"', cor[5])),
            parse(text=sprintf('rho=="%.2f"', cor[6])),
            parse(text=sprintf('rho=="%.2f"', cor[7])),
            parse(text=sprintf('rho=="%.2f"', cor[8])))

g1 <- ggplot(df, aes(x=RNA, y=K27up1000)) +
  geom_point(size=1) +
  geom_abline(intercept=1, slope=-1, linetype="dashed") +
  annotate("text", x=0.85, y=0.95, 
           label=mylabs[1], size=7/ggplot2::.pt) +
  theme_bw() +
  theme(axis.title=element_text(size=7), 
        axis.text=element_text(size=7)) + 
  labs(title="", 
...
g2 <- ggplot(df, aes(x=K4, y=K27up1000)) +
  geom_point(size=1) +
  geom_abline(intercept=1, slope=-1, linetype="dashed") +
  annotate("text", x=0.85, y=0.95, 
           label=mylabs[2], size=7/ggplot2::.pt) +
  theme_bw() +
  theme(axis.title=element_text(size=7), 
        axis.text=element_text(size=7)) + 
  labs(title="", 
...
g3 <- ggplot(df, aes(x=RNA, y=K27up2000)) +
  geom_point(size=1) +
  geom_abline(intercept=1, slope=-1, linetype="dashed") +
  annotate("text", x=0.85, y=0.95, 
           label=mylabs[3], size=7/ggplot2::.pt) +
  theme_bw() +
  theme(axis.title=element_text(size=7), 
        axis.text=element_text(size=7)) + 
  labs(title="", 
...
g4 <- ggplot(df, aes(x=K4, y=K27up2000)) +
  geom_point(size=1) +
  geom_abline(intercept=1, slope=-1, linetype="dashed") +
  annotate("text", x=0.85, y=0.95, 
           label=mylabs[4], size=7/ggplot2::.pt) +
  theme_bw() +
  theme(axis.title=element_text(size=7), 
        axis.text=element_text(size=7)) + 
  labs(title="", 
...
g5 <- ggplot(df, aes(x=RNA, y=K27up3000)) +
  geom_point(size=1) +
  geom_abline(intercept=1, slope=-1, linetype="dashed") +
  annotate("text", x=0.85, y=0.95, 
           label=mylabs[5], size=7/ggplot2::.pt) +
  theme_bw() +
  theme(axis.title=element_text(size=7), 
        axis.text=element_text(size=7)) + 
  labs(title="", 
...
g6 <- ggplot(df, aes(x=K4, y=K27up3000)) +
  geom_point(size=1) +
  geom_abline(intercept=1, slope=-1, linetype="dashed") +
  annotate("text", x=0.85, y=0.95, 
           label=mylabs[6], size=7/ggplot2::.pt) +
  theme_bw() +
  theme(axis.title=element_text(size=7), 
        axis.text=element_text(size=7)) + 
  labs(title="", 
...
g7 <- ggplot(df, aes(x=RNA, y=K27up6000)) +
  geom_point(size=1) +
  geom_abline(intercept=1, slope=-1, linetype="dashed") +
  annotate("text", x=0.85, y=0.95, 
           label=mylabs[7], size=7/ggplot2::.pt) +
  theme_bw() +
  theme(axis.title=element_text(size=7), 
        axis.text=element_text(size=7)) + 
  labs(title="", 
...
g8 <- ggplot(df, aes(x=K4, y=K27up6000)) +
  geom_point(size=1) +
  geom_abline(intercept=1, slope=-1, linetype="dashed") +
  annotate("text", x=0.85, y=0.95, 
           label=mylabs[8], size=7/ggplot2::.pt) +
  theme_bw() +
  theme(axis.title=element_text(size=7), 
        axis.text=element_text(size=7)) + 
  labs(title="", 
...
ggsave("../figs/scatter/ADH1scatter_RNA_K4_K27TSSup1000-6000_monthmean_210309.pdf", 
       gall, height = 8, width = 3.9)
